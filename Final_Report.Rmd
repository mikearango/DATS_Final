...
prediction_rf1_rf2_test <- dplyr::rename(prediction_rf1_rf2_test, Actual_SalePrice=df_test.saleprice, Prediction_RF1_SalePrice=pred_rf1, Prediction_RF2_SalePrice=pred_rf2)
# output to table
stargazer(prediction_rf1_rf2_test, type="html", title="Table 5: Prediction Results", header=FALSE)
