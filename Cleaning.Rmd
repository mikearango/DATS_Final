...
Because `r round(2587/(2587+23+9+7+4),4) * 100`% of `roof.matl` (roof material) is `CompShg` with the remainign spread across 7 categories, we transformed the data to Comp.Shg or not.
```{r}
