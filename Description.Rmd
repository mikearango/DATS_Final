...
df <- read.xls('./data/AmesHousing.xls', stringsAsFactors = TRUE) #na.strings = "EMPTY"
glimpse(df)
```
...
There appear to be 3 "partial sales" outliers that we will drop (high square footage but low sale price), as apparent from the above graph.

```{r}
# drop the outlier "partial sales"
